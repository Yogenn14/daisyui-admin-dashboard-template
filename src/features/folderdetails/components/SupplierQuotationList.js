...
const QuotationList = ({ supplierQuotations, quotationFileExtensions }) => {
  ...
  return (
    <tbody>
      {supplierQuotations.map((file, index) => {
        const fileExtension = Array.isArray(quotationFileExtensions)
          ? quotationFileExtensions[index].slice(1)
          : "";
