...
const POlist = ({ supplierPO, poExtensions }) => {
  ...
  return (
    <tbody>
      {supplierPO.map((file, index) => {
        const fileExtension = Array.isArray(poExtensions)
          ? poExtensions[index].slice(1)
          : "";
        console.log(poExtensions, "poExtensions");
